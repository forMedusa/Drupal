...
/* themes/custom/butterscotch/templates/field--node--field-product-features.html.twig */
class __TwigTemplate_6a57446846e3e2f09bee1e36f6658d80 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 64
                echo "      <div class=\"productFeatures\" ";
...
";
    ...
    {
        return "themes/custom/butterscotch/templates/field--node--field-product-features.html.twig";
    }
...
{% else %}
  <div{{ attributes }}>
    ...
    {% endif %}
    {% for item in items %}
      <div class=\"productFeatures\" {{ item.attributes }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/custom/butterscotch/templates/field--node--field-product-features.html.twig", "/var/www/html/web/themes/custom/butterscotch/templates/field--node--field-product-features.html.twig");
    }
