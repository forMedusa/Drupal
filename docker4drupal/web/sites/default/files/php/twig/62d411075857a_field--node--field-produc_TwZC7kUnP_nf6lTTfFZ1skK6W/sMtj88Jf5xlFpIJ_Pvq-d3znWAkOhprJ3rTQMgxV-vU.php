...
/* themes/custom/butterscotch/templates/field--node--field-product-availability.html.twig */
class __TwigTemplate_0777d5e2e12c99c5a90bc81ddc978c2d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    ";
            ...
            echo ">
    <div style=\"text-align:center; margin-top:2%; font-size:20px; font-weight:600;\"";
            // line 59
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 64
                echo "      <div class=\"available\" style=\"text-align:center;\"";
...
";
    ...
    {
        return "themes/custom/butterscotch/templates/field--node--field-product-availability.html.twig";
    }
...
{% else %}
  <div{{ attributes }}>
    <div style=\"text-align:center; margin-top:2%; font-size:20px; font-weight:600;\"{{ title_attributes.addClass(title_classes) }}>{{ label }}</div>
    {% if multiple %}
      <div>
    {% endif %}
    {% for item in items %}
      <div class=\"available\" style=\"text-align:center;\"{{ item.attributes }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/custom/butterscotch/templates/field--node--field-product-availability.html.twig", "/var/www/html/web/themes/custom/butterscotch/templates/field--node--field-product-availability.html.twig");
    }
