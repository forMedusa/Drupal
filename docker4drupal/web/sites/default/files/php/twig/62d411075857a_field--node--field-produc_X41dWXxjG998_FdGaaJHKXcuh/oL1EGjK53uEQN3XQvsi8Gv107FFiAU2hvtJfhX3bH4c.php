...
/* themes/custom/butterscotch/templates/field--node--field-product-price.html.twig */
class __TwigTemplate_5cd19451d84ece3c31ce74a1aa3dccf3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/butterscotch/templates/field--node--field-product-price.html.twig";
    }
    ...
    {
        return array (  128 => 68,  124 => 66,  121 => 65,  110 => 63,  105 => 62,  101 => 60,  99 => 59,  94 => 58,  90 => 56,  79 => 54,  74 => 53,  70 => 51,  59 => 49,  55 => 48,  50 => 47,  47 => 46,  45 => 45,  42 => 44,  40 => 41,  39 => 40,);
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes }}>
      {% for item in items %}
        <div class=\"productName\" {{ item.attributes }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
      <div class=\"productImage\" {{ attributes }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes }}>
    ...
    {% endif %}
    {% for item in items %}
      <div class=\"productPrice\" {{ item.attributes }}>{{ item.content }}</div>
    {% endfor %}
    {% if multiple %}
      </div>
    {% endif %}
...
{% endif %}
", "themes/custom/butterscotch/templates/field--node--field-product-price.html.twig", "/var/www/html/web/themes/custom/butterscotch/templates/field--node--field-product-price.html.twig");
    }
